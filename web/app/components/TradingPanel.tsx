    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex shrink-0">
        <button onClick={() => handleOutcomeChange("yes")}
          ...
          style={isYes ? { background: "linear-gradient(180deg, rgba(14,203,129,0.08) 0%, rgba(14,203,129,0.03) 100%)" } : {}}>
        ...
        <button onClick={() => handleOutcomeChange("no")}
          ...
          style={!isYes ? { background: "linear-gradient(180deg, rgba(246,70,93,0.08) 0%, rgba(246,70,93,0.03) 100%)" } : {}}>
      ...
      <div className="flex flex-col px-3 pb-3 gap-2.5 border-x border-b border-[#1a1a1a] rounded-b-lg"
        style={{ background: isYes
          ? "linear-gradient(180deg, rgba(14,203,129,0.03) 0%, rgba(14,203,129,0.015) 50%, #0d0d0d 80%)"
          : "linear-gradient(180deg, rgba(246,70,93,0.03) 0%, rgba(246,70,93,0.015) 50%, #0d0d0d 80%)"
        }}>
