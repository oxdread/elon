  ...
  return (
    <div className="h-full bg-[#060606] flex flex-col p-2 gap-2 overflow-hidden">
        ...
        <div className="flex gap-2 shrink-0">
          ...
          <div style={{ width: "calc(68% + 4px)" }} className="shrink-0 bg-[#0d0d0d] rounded-lg border border-[#1a1a1a] px-4 py-3">
        ...
        <div className="flex-1 flex gap-2 min-h-0">
          ...
          <div className="w-[38%] shrink-0 bg-[#0d0d0d] rounded-lg border border-[#1a1a1a] flex flex-col overflow-hidden">            <div className="px-3 py-2 border-b border-[#1a1a1a] shrink-0 flex items-center justify-between">
