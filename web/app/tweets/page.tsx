  ...
  return (
    <div className="h-full bg-[#060606] flex flex-col p-2 gap-2 overflow-hidden">
        ...
        <div className="flex-1 flex gap-2 min-h-0">
          ...
          <div className="w-[33%] shrink-0 bg-[#0d0d0d] rounded-lg border border-[#1a1a1a] overflow-hidden px-1 py-1">
            ...
            <div className="flex-[4] bg-[#0d0d0d] rounded-lg border border-[#1a1a1a] flex flex-col overflow-hidden min-h-0">
              ...
              <div className="flex-1 overflow-y-auto">
                {trackerTrades.length === 0 ? (
                  <div className="flex items-center justify-center h-full text-[#555555] text-xs">No trades yet</div>
                ) : (
